  ...
  return (
    <div className="overflow-hidden pb-12 bg-white">
      <nav className="flex gap-3.5 items-center px-20 py-8 mt-3.5 text-base bg-orange-50 text-neutral-400 max-md:px-5">
        ...
        <img
          src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/db13939cabd153a09de09c25864d1f622bda5d116dbe6552d6605aca283c27a4?placeholderIfAbsent=true"
      ...
      <div>
            ...
            <div className="flex gap-5 max-md:flex-col">
                ...
                <div className="flex gap-8">
                  <div className="flex flex-col gap-8">
                    <img
                      ...
                      className="w-[75px] h-[75px] object-cover bg-[#F9F1E7] rounded-lg"
                    />
                    <img
                      src={product.imageUrl}
                      alt="Sofa thumbnail 1"
                  ...
                  <div className="w-full max-w-[600px] ">
                    <img
                      src={product.imageUrl}
                      alt="Asgaard sofa"
                      className="w-full h-[510px] object-cover bg-[#F9F1E7] rounded-lg"
                    />
                  </div>
                </div>
              </div>
              <article className="ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col items-start w-full max-md:mt-10 max-md:max-w-full">
                  <h1 className="text-5xl text-black mb-5">
                    {product.title || product.name}
                  </h1>
                  ...
                  <div className="flex gap-5 items-center mt-2.5 text-sm text-neutral-400">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/35cb519968837ecbbf7790f3c128da597ab6c33dd10c0353875022f7f2dc3781?placeholderIfAbsent=true"
                      alt="Rating stars"
                      className="object-contain max-w-full aspect-[6.21] w-[124px]"
                    />
                  ...
                  <div className="mt-5">
                    ...
                    <div className="flex gap-4 mt-3">
                      <button
                        ...
                        className="flex shrink-0 bg-violet-500 h-[30px] rounded-[50px] w-[30px]"
                      ></button>
                      <button
                        aria-label="Black color"
                        className="flex shrink-0 bg-black h-[30px] rounded-[50px] w-[30px]"
                      ></button>
                      <button
                        aria-label="Yellow color"
                        className="flex shrink-0 bg-yellow-600 h-[30px] rounded-[50px] w-[30px]"
                      ></button>
                    </div>
                  </div>
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <dd className="flex gap-5">
                <a href="#" aria-label="Share on Facebook">
                  <img
                    src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/df84bf565ad8d18448095eab4442c035367a0f2e13e9265891d051b7b570503c?placeholderIfAbsent=true"
                    alt="Facebook"
                    className="object-contain w-5 aspect-square"
                  />
                </a>
                <a href="#" aria-label="Share on LinkedIn">
                  <img
                    src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/fbbcdd7a5216cfdc1f66c0b19d56e713cc01cdd404ed8c7705318c01acb2b31f?placeholderIfAbsent=true"
                    alt="LinkedIn"
                    className="object-contain w-5 aspect-square"
                  />
                </a>
                <a href="#" aria-label="Share on Twitter">
                  <img
                    src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/ac547bd4addefd8e4b2d50f2cd114a8157c1961189437cc9486cc350f82eadb2?placeholderIfAbsent=true"
                    alt="Twitter"
                    className="object-contain w-5 aspect-square"
                  />
                </a>
        ...
        <section className="flex flex-col items-center pt-12 w-full bg-white max-md:max-w-full">
          <nav className="flex flex-wrap gap-10 max-w-full text-2xl text-neutral-400 w-[649px]">
            ...
            <button className="grow shrink w-[242px]">
          ...
          <div className="mt-11 w-full max-w-[1239px] max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col">
              <img
                src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/28e49458615ff4652af38782ca0920dd87b50bbd800f02b33bedfa38cb9004a2?placeholderIfAbsent=true"
                alt="Product detail 1"
                className="w-6/12 object-contain aspect-[1.74] max-md:w-full max-md:mt-7"
              />
              <img
                src="https://cdn.builder.io/api/v1/image/assets/fade7a66245c4bb8b027677c62a79354/e0d668fb1c9796b2982e836921a211521051db779b5e03326e9ec1b85104e755?placeholderIfAbsent=true"
        ...
        <section className="flex flex-col items-center px-20 pt-14 pb-28 w-full bg-white max-md:px-5 max-md:pb-24 max-md:max-w-full">
          ...
          <div className="flex flex-wrap gap-8 items-center mt-7 max-md:max-w-full">
            {relatedProducts.map((item) => (
              <article
                key={item.id}
                className="self-stretch my-auto min-w-60 w-[285px]"
              >
                <div className="relative">
                  <img
                    src={item.imageUrl}
                    className="w-full aspect-[0.947] object-cover"
                  />
                  <span className="absolute top-6 right-7 px-px w-12 h-12 bg-red-400 rounded-full flex items-center justify-center text-base font-medium text-white">
                    -30%
                  </span>
                </div>
